...
<body>
	...
	<form name="loginform" method="post" action="loginform" id="loginform">
		<br />
		<input type="hidden" name="method" value=ubmitTabl"se"/>
						...
						<div class="login_frame">
							...
							<div class="co_login">
								<span>疯狂源自梦想,技术成就辉煌</span><!-- <a class="icon_sina"
									id="open_sina_sign" href="" title="二维码">二维码</a> //images/weixin.jpg -->
							</div>
						</div>
					</div>
				</div>
